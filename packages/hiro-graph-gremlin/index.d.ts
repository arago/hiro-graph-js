export class GremlinQueryBuilder {
  ...
  transform(
    transforms: Array<string | GremlinQueryBuilder> | { [key: string]: string | GremlinQueryBuilder }
  ): GremlinQueryBuilder;
  copySplit(paths: Array<GremlinQueryBuilder | string>, mergeType: "fairMerge" | "exhaustMerge"): GremlinQueryBuilder;
  ...
  addComputedProp(name: string, query: GremlinQueryBuilder | string): GremlinQueryBuilder;
...
export default function queryBuilder(initialQuery: string | GremlinQueryBuilder): GremlinQueryBuilder;

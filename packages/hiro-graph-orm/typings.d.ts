declare module "hiro-graph-orm" {
    ...
    export class Entity extends BaseContext {
        create(data, options?: object): Promise<GraphVertex>;
        connect(
            relation: string,
    ...
    export class Context extends BaseContext implements MyData {
        constructor(
        ...
        getClient(): Client;
        setCache(cache: Map<string, object>);
